...
OPENROUTER_CONFIG = {
    ...
    'API_KEY': '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',
    'MODEL': 'qwen/qwen3-8b:free',  # Default model - FREE - cost effective
    'MAX_TOKENS': 2000,
    'TEMPERATURE': 0.7,
    'MODELS': {
        # === QWEN MODELS ===
        ...
        'qwen2.5-coder-32b': 'qwen/qwen-2.5-coder-32b-instruct:free',
        ...
        'deepseek-r1-0528-qwen3': 'deepseek/deepseek-r1-0528-qwen3-8b:free',
        'deepseek-r1-distill-llama': 'deepseek/deepseek-r1-distill-llama-70b:free',
        ...
        'kimi-vl-a3b': 'moonshotai/kimi-vl-a3b-thinking:free',
        'deephermes-3-llama': 'nousresearch/deephermes-3-llama-3-8b-preview:free',
        'reka-flash-3': 'rekaai/reka-flash-3:free',
        'shisa-v2-llama': 'shisa-ai/shisa-v2-llama3.3-70b:free',
        ...
        'dolphin3-r1-mistral': 'cognitivecomputations/dolphin3.0-r1-mistral-24b:free',
        'dolphin-venice-edition': 'cognitivecomputations/dolphin-mistral-24b-venice-edition:free',
...
def test_gemini():
    """Legacy endpoint - Test Google Gemini API connection"""
